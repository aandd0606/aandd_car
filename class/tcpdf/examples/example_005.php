...
$pdf->SetAuthor('曾亦菖');
$pdf->SetTitle('冠昌車業');
$pdf->SetSubject('冠昌車業汽車保修管理系統');
$pdf->SetKeywords('冠昌車業, 汽車, 保養');

// set default header data
$pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, "冠昌車業（汽車保修專營）",  "by 曾亦菖 http://xxx.com.tw");
...
// Multicell test
$pdf->MultiCell(90, 60, '[LEFT] '.$txt, 1, 'L', 1, 0, '', '', true);
$pdf->MultiCell(90, 30, '[RIGHT] '.$txt, 1, 'R', 0, 1, '', '', true);
